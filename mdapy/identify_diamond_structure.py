...
class IdentifyDiamondStructure:
    ...
    def __init__(self, 
        ...
        self.structure = ["other", "cubic_diamond", 
    ...
    def compute(self,):
        ...
        _cna._ids(self.pos, self.box, self.inverse_box, np.bool_(self.boundary), self.verlet_list, new_verlet_list, self.pattern)
